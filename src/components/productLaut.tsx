...
return (
<>
    <h2 className='pt-8 pb-4 text-2xl font-bold text-black'>Produk Hasil Laut Pangandaran</h2>
    <h5 className='pt-2 pb-4 text-black '>Untukmu yang bingung mau beli apa</h5>
