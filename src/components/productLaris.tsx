        ...
        <>
            ...
            <div className="pb-12">
                <Swiper slidesPerView={1} spaceBetween={10} pagination={{
                    ...
                    <SwiperSlide>
                        <div className="block w-40 p-2 mx-8 text-black bg-white border border-gray-200 rounded-lg">
                            <Image className="" src="/images/icon/KeripikPangkis.svg" alt="ImageCards" width={150} height={100} />
                            <div className="p-2">
                    ...
                    <SwiperSlide>
                        <div className="block w-40 p-2 mx-8 text-black bg-white border border-gray-200 rounded-lg">
                            <Image className="" src="/images/icon/IkanJambal.png" alt="ImageCards" width={150} height={10} />
                            <div className="p-2">
